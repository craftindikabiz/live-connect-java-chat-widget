...
```kotlin
dependencies {
    implementation("com.github.craftindikabiz:live-connect-java-chat-widget:v1.0.2")
}
```
...
`https://jitpack.io/#craftindikabiz/live-connect-java-chat-widget/v1.0.2` in a browser and click **Get it** to force a rebuild.
